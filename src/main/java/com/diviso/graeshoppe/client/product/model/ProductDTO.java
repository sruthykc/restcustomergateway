...
public class ProductDTO {
	...
	public boolean equals(java.lang.Object o) {
		...
		return Objects.equals(this.brandId, productDTO.brandId) && Objects.equals(this.buyPrice, productDTO.buyPrice)
				&& Objects.equals(this.categoryId, productDTO.categoryId)
				&& Objects.equals(this.discountId, productDTO.discountId)
				&& Objects.equals(this.iDPcode, productDTO.iDPcode) && Objects.equals(this.id, productDTO.id)
				...
				&& Objects.equals(this.name, productDTO.name) && Objects.equals(this.reference, productDTO.reference)
				&& Objects.equals(this.sellingPrice, productDTO.sellingPrice)
				&& Objects.equals(this.showInCatalogue, productDTO.showInCatalogue)
				&& Objects.equals(this.sku, productDTO.sku) && Objects.equals(this.storageCost, productDTO.storageCost)
	...
	@Override
	public int hashCode() {
		return Objects.hash(brandId, buyPrice, categoryId, discountId, iDPcode, id, image, imageContentType, isActive,
				isAuxilaryItem, isServiceItem, locationId, manufacturerId, maxQuantityLevel, minQuantityLevel, name,
				reference, sellingPrice, showInCatalogue, sku, storageCost, supplierId, taxCategoryId, unitId);
	}
